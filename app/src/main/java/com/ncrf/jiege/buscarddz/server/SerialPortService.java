                        ...
                        if (message.equalsIgnoreCase("FF020701000402000101831F")) {
                            ...
                            if (xxz.equals("03")) {
                                ...
                                if (!is7f) {
                                    ...
                                    // 下行
                                    if (sxxbz == 1) {
                                        ((MainActivity) MainActivity.context).setDrawin(MyApplication.xxlist.size() - dzxh + 1,
                                                MyApplication.xxlist, islz);
                                    } else {
                                    ...
                                    // 下行
                                    if (sxxbz == 2) {
                                        ((MainActivity) MainActivity.context).setDrawin(dzxh - MyApplication.sxlist.size(), MyApplication.xxlist, islz);
                                    } else {
                                        ((MainActivity) MainActivity.context).setDrawin(dzxh, MyApplication.sxlist, islz);
                                    }
                                }
